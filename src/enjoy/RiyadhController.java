...
public class RiyadhController implements Initializable {
    ...
    @FXML 
    private void moveDescption(MouseEvent e) throws IOException {
        Parent Back = FXMLLoader.load(getClass().getResource("DescptionRahayi.fxml"));
        Scene back = new Scene(Back);
        Stage stage = (Stage)((Node)e.getSource()).getScene().getWindow();
        stage.setScene(back);
        stage.setTitle("ENJOY");
